...
type CometClient interface {
	...
	SendToUsers(ctx context.Context, in *SendToUsersReq, opts ...grpc.CallOption) (*SendToUsersReply, error)
...
func (c *cometClient) SendToUsers(ctx context.Context, in *SendToUsersReq, opts ...grpc.CallOption) (*SendToUsersReply, error) {
	out := new(SendToUsersReply)
	err := c.cc.Invoke(ctx, Comet_SendToUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cometClient) SendToRoom(ctx context.Context, in *SendToRoomReq, opts ...grpc.CallOption) (*SendToRoomReply, error) {
	...
	err := c.cc.Invoke(ctx, Comet_SendToRoom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cometClient) SendToAll(ctx context.Context, in *SendToAllReq, opts ...grpc.CallOption) (*SendToAllReply, error) {
	...
	err := c.cc.Invoke(ctx, Comet_SendToAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cometClient) GetAllRoomId(ctx context.Context, in *GetAllRoomIdReq, opts ...grpc.CallOption) (*GetAllRoomIdReply, error) {
	...
	err := c.cc.Invoke(ctx, Comet_GetAllRoomId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CometServer interface {
	// send msg to some user
	SendToUsers(context.Context, *SendToUsersReq) (*SendToUsersReply, error)
	// send msg with room's user
