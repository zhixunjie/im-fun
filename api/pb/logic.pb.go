...
func (KafkaSendMsg_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_logic_proto_enumTypes[2].Descriptor()
}

func (KafkaSendMsg_Type) Type() protoreflect.EnumType {
	return &file_logic_proto_enumTypes[2]
}
...
type Atom struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SeqId         string                 `protobuf:"bytes,1,opt,name=seq_id,json=seqId,proto3" json:"seq_id,omitempty"`                     // 请求序列号（用于链路追踪、幂等操作等）
	Uid           int64                  `protobuf:"varint,2,opt,name=uid,proto3" json:"uid,omitempty"`                                     // 用户ID
	Did           string                 `protobuf:"bytes,3,opt,name=did,proto3" json:"did,omitempty"`                                      // 设备ID
	App           App                    `protobuf:"varint,4,opt,name=app,proto3,enum=imfun.logic.App" json:"app,omitempty"`                // app id
	Platform      Platform               `protobuf:"varint,5,opt,name=platform,proto3,enum=imfun.logic.Platform" json:"platform,omitempty"` // 平台
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Atom) GetPlatform() Platform {
	if x != nil {
		return x.Platform
	}
	return Platform_Platform_None
...
const file_logic_proto_rawDesc = "" +
	...
	"\tmax_delay\x18\x04 \x01(\x05R\bmaxDelay\"\x98\x01\n" +
	"\x04Atom\x12\x15\n" +
	"\x06seq_id\x18\x01 \x01(\tR\x05seqId\x12\x10\n" +
	"\x03uid\x18\x02 \x01(\x03R\x03uid\x12\x10\n" +
	"\x03did\x18\x03 \x01(\tR\x03did\x12\"\n" +
	"\x03app\x18\x04 \x01(\x0e2\x10.imfun.logic.AppR\x03app\x121\n" +
	"\bplatform\x18\x05 \x01(\x0e2\x15.imfun.logic.PlatformR\bplatform*\x92\x01\n" +
	"\bPlatform\x12\x11\n" +
	...
	"\x13Platform_MinProgram\x10\x06*\x1f\n" +
	"\x03App\x12\f\n" +
	"\bApp_None\x10\x00\x12\n" +
	"\n" +
	"\x06App_Im\x10\x012\x86\x03\n" +
	"\x05Logic\x12<\n" +
...
var file_logic_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_logic_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_logic_proto_goTypes = []any{
	(Platform)(0),          // 0: imfun.logic.Platform
	(App)(0),               // 1: imfun.logic.App
	(KafkaSendMsg_Type)(0), // 2: imfun.logic.KafkaSendMsg.Type
	(*KafkaSendMsg)(nil),   // 3: imfun.logic.KafkaSendMsg
	(*TcpConnection)(nil),  // 4: imfun.logic.TcpConnection
	(*TcpUserInfo)(nil),    // 5: imfun.logic.TcpUserInfo
	(*AuthParams)(nil),     // 6: imfun.logic.AuthParams
	(*ConnectReq)(nil),     // 7: imfun.logic.ConnectReq
	(*ConnectResp)(nil),    // 8: imfun.logic.ConnectResp
	(*HbCfg)(nil),          // 9: imfun.logic.HbCfg
	(*DisconnectReq)(nil),  // 10: imfun.logic.DisconnectReq
	(*DisconnectResp)(nil), // 11: imfun.logic.DisconnectResp
	(*HeartbeatReq)(nil),   // 12: imfun.logic.HeartbeatReq
	(*HeartbeatResp)(nil),  // 13: imfun.logic.HeartbeatResp
	(*OnlineReq)(nil),      // 14: imfun.logic.OnlineReq
	(*OnlineResp)(nil),     // 15: imfun.logic.OnlineResp
	(*ReceiveReq)(nil),     // 16: imfun.logic.ReceiveReq
	(*ReceiveResp)(nil),    // 17: imfun.logic.ReceiveResp
	(*NodesReq)(nil),       // 18: imfun.logic.NodesReq
	(*NodesResp)(nil),      // 19: imfun.logic.NodesResp
	(*Backoff)(nil),        // 20: imfun.logic.Backoff
	(*Atom)(nil),           // 21: imfun.logic.Atom
	nil,                    // 22: imfun.logic.OnlineReq.RoomCountEntry
	nil,                    // 23: imfun.logic.OnlineResp.AllRoomCountEntry
	(*protocol.Proto)(nil), // 24: imfun.protocol.Proto
}
var file_logic_proto_depIdxs = []int32{
	2,  // 0: imfun.logic.KafkaSendMsg.type:type_name -> imfun.logic.KafkaSendMsg.Type
	4,  // 1: imfun.logic.TcpUserInfo.connect:type_name -> imfun.logic.TcpConnection
	0,  // 2: imfun.logic.TcpUserInfo.platform:type_name -> imfun.logic.Platform
	9,  // 3: imfun.logic.TcpUserInfo.hb_cfg:type_name -> imfun.logic.HbCfg
	0,  // 4: imfun.logic.AuthParams.platform:type_name -> imfun.logic.Platform
	6,  // 5: imfun.logic.ConnectReq.authParams:type_name -> imfun.logic.AuthParams
	9,  // 6: imfun.logic.ConnectResp.hb_cfg:type_name -> imfun.logic.HbCfg
	4,  // 7: imfun.logic.DisconnectReq.connect:type_name -> imfun.logic.TcpConnection
	4,  // 8: imfun.logic.HeartbeatReq.connect:type_name -> imfun.logic.TcpConnection
	22, // 9: imfun.logic.OnlineReq.roomCount:type_name -> imfun.logic.OnlineReq.RoomCountEntry
	23, // 10: imfun.logic.OnlineResp.allRoomCount:type_name -> imfun.logic.OnlineResp.AllRoomCountEntry
	24, // 11: imfun.logic.ReceiveReq.proto:type_name -> imfun.protocol.Proto
	0,  // 12: imfun.logic.NodesReq.platform:type_name -> imfun.logic.Platform
	9,  // 13: imfun.logic.NodesResp.hb_cfg:type_name -> imfun.logic.HbCfg
	20, // 14: imfun.logic.NodesResp.backoff:type_name -> imfun.logic.Backoff
	1,  // 15: imfun.logic.Atom.app:type_name -> imfun.logic.App
	0,  // 16: imfun.logic.Atom.platform:type_name -> imfun.logic.Platform
	7,  // 17: imfun.logic.Logic.Connect:input_type -> imfun.logic.ConnectReq
	10, // 18: imfun.logic.Logic.Disconnect:input_type -> imfun.logic.DisconnectReq
	12, // 19: imfun.logic.Logic.Heartbeat:input_type -> imfun.logic.HeartbeatReq
	14, // 20: imfun.logic.Logic.RenewOnline:input_type -> imfun.logic.OnlineReq
	16, // 21: imfun.logic.Logic.Receive:input_type -> imfun.logic.ReceiveReq
	18, // 22: imfun.logic.Logic.Nodes:input_type -> imfun.logic.NodesReq
	8,  // 23: imfun.logic.Logic.Connect:output_type -> imfun.logic.ConnectResp
	11, // 24: imfun.logic.Logic.Disconnect:output_type -> imfun.logic.DisconnectResp
	13, // 25: imfun.logic.Logic.Heartbeat:output_type -> imfun.logic.HeartbeatResp
	15, // 26: imfun.logic.Logic.RenewOnline:output_type -> imfun.logic.OnlineResp
	17, // 27: imfun.logic.Logic.Receive:output_type -> imfun.logic.ReceiveResp
	19, // 28: imfun.logic.Logic.Nodes:output_type -> imfun.logic.NodesResp
