...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserType = field.NewUint32(tableName, "user_type")
	_user.AccountType = field.NewUint32(tableName, "account_type")
	_user.AccountID = field.NewString(tableName, "account_id")
	_user.Nickname = field.NewString(tableName, "nickname")
	_user.Avatar = field.NewString(tableName, "avatar")
	_user.Sex = field.NewUint32(tableName, "sex")
...
type user struct {
	...
	UserType    field.Uint32 // 用户类型
	AccountType field.Uint32 // 账号类型
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserType = field.NewUint32(table, "user_type")
	u.AccountType = field.NewUint32(table, "account_type")
	u.AccountID = field.NewString(table, "account_id")
	u.Nickname = field.NewString(table, "nickname")
	u.Avatar = field.NewString(table, "avatar")
	u.Sex = field.NewUint32(table, "sex")
