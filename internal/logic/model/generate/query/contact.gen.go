...
import (
	...
	"github.com/zhixunjie/im-fun/internal/logic/model/generate/model"
)
...
func newContact(db *gorm.DB, opts ...gen.DOOption) contact {
	...
	_contact.OwnerID = field.NewInt64(tableName, "owner_id")
	_contact.PeerID = field.NewInt64(tableName, "peer_id")
	_contact.PeerType = field.NewInt32(tableName, "peer_type")
	_contact.PeerAck = field.NewInt32(tableName, "peer_ack")
	_contact.LastMsgID = field.NewInt64(tableName, "last_msg_id")
	_contact.LastDelMsgID = field.NewInt64(tableName, "last_del_msg_id")
	_contact.VersionID = field.NewInt64(tableName, "version_id")
	_contact.SortKey = field.NewInt64(tableName, "sort_key")
	_contact.Status = field.NewInt32(tableName, "status")
...
type contact struct {
	...
	ALL          field.Asterisk
	ID           field.Int64  // 自增id,主键
	OwnerID      field.Int64  // 会话拥有者
	PeerID       field.Int64  // 联系人（对方用户）
	PeerType     field.Int32  // 联系人类型，0：普通，100：系统，101：群组
	PeerAck      field.Int32  // peer_id是否给owner发过消息，0：未发过，1：发过
	LastMsgID    field.Int64  // 聊天记录中，最新一条发送的私信id
	LastDelMsgID field.Int64  // 聊天记录中，最后一次删除联系人时的私信id
	VersionID    field.Int64  // 版本id（用于拉取会话框）
	SortKey      field.Int64  // 会话展示顺序（按顺序展示会话）可修改顺序，如：置顶操作
	Status       field.Int32  // 联系人状态，0：正常，1：被删除
...
func (c *contact) updateTableName(table string) *contact {
	...
	c.PeerID = field.NewInt64(table, "peer_id")
	c.PeerType = field.NewInt32(table, "peer_type")
	c.PeerAck = field.NewInt32(table, "peer_ack")
	c.LastMsgID = field.NewInt64(table, "last_msg_id")
	c.LastDelMsgID = field.NewInt64(table, "last_del_msg_id")
	c.VersionID = field.NewInt64(table, "version_id")
	c.SortKey = field.NewInt64(table, "sort_key")
