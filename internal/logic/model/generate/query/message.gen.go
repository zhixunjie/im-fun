...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.SeqID = field.NewInt64(tableName, "seq_id")
	_message.MsgType = field.NewInt32(tableName, "msg_type")
	...
	_message.VersionID = field.NewInt64(tableName, "version_id")
	_message.SortKey = field.NewInt64(tableName, "sort_key")
	_message.Status = field.NewInt32(tableName, "status")
	_message.HasRead = field.NewInt32(tableName, "has_read")
...
type message struct {
	...
	ALL           field.Asterisk
	MsgID         field.Int64  // 消息唯一id（服务端生成）
	SeqID         field.Int64  // 消息唯一id（客户端生成）
	MsgType       field.Int32  // 消息类型
	Content       field.String // 消息内容，json格式
	SessionID     field.String // 会话id
	SendID        field.Int64  // 私信发送者id
	VersionID     field.Int64  // 版本id（用于拉取消息）
	SortKey       field.Int64  // 消息展示顺序（按顺序展示消息）
	Status        field.Int32  // 消息状态。0：正常，1：被审核删除，2：撤销
	HasRead       field.Int32  // 消息接收者是否已读消息。0：未读，1：已读
...
func (m *message) updateTableName(table string) *message {
	...
	m.SeqID = field.NewInt64(table, "seq_id")
	...
	m.VersionID = field.NewInt64(table, "version_id")
	m.SortKey = field.NewInt64(table, "sort_key")
	m.Status = field.NewInt32(table, "status")
	m.HasRead = field.NewInt32(table, "has_read")
